package com.hudson.myrecyclerview;
...
public class SelectProgressBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if(attrs!=null){
            ...
            mRadius = (int)ta.getDimension(R.styleable.SelectProgressBar_circle_radius,mRadius);
            ...
            mTextSize = (int) ta.getDimension(R.styleable.SelectProgressBar_text_size,mTextSize);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        System.out.println("结束的宽度"+endTextWidth);
        if(mStyle == Style.HORIZONTAL){
